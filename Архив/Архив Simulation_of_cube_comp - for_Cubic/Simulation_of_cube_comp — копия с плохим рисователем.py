...
def painting_cube():
	...
	def square(x, y, size, color = 'red'):
		square =  gr.Rectangle(gr.Point(x, y), gr.Point(x + 2*size, y + 2*size))
		square.setFill(color)
		square.setWidth(width - 3)
		square.draw(window)

																			#left_side
	side_x, side_y = x, y
	side(side_x, side_y, size)
	
	
		
	
	
	square(side_x + width, side_y + width, square_size)
	square(side_x + width + 2*(width - 3) + 2*square_size, side_y + width, square_size)
	square(side_x + width + 4*(width - 3) + 4*square_size, side_y + width, square_size)
	
	square(side_x + width, side_y + width + 2*(width - 3) + 2*square_size, square_size)
	square(side_x + width + 2*(width - 3) + 2*square_size, side_y + width + 2*(width - 3) + 2*square_size, square_size)
	square(side_x + width + 4*(width - 3) + 4*square_size, side_y + width + 2*(width - 3) + 2*square_size, square_size)
	
	square(side_x + width, side_y + width + 4*(width - 3) + 4*square_size, square_size)
	square(side_x + width + 2*(width - 3) + 2*square_size, side_y + width + 4*(width - 3) + 4*square_size, square_size)
	square(side_x + width + 4*(width - 3) + 4*square_size, side_y + width + 4*(width - 3) + 4*square_size, square_size)
																			#front_side
