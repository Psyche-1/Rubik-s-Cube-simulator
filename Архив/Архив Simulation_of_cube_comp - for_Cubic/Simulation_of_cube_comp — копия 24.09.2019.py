...
def saving_cube(cube_list_for_saving, where_saving='Save_to_last', with_txt='completely'):
	'''
	...
	if with_txt in ['completely', 'c', 'y', 'yes']:
	...
	if where_saving == 'Save_to_last':
		shelf_file[where_saving] = cube_list_for_saving # Сохранение

	elif  where_saving == 'Save_to_mine':
		shelf_file[where_saving] = cube_list_for_saving # Сохранение

	elif where_saving == 'Save_start':
		shelf_file[where_saving] = cube_list_for_saving
		#Один раз сохранить, а потом закомментить либо оставить и запускать, чтобы точно был начальным #?

	shelf_file.close
#"""
saving_cube(cube_list, 'Save_start', 'n')
#saving_cube(cube_list, 'Save_to_last', 'n')
#saving_cube(cube_list, 'Save_to_mine', 'n')



def loading_cube(wherefrom_loading='Loading_from_last'):
	'''
