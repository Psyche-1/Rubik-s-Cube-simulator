...
# Form implementation generated from reading ui file 'E:\Программы\Программирование\Python\С телефона\Копии для редактирования на компе\Кубик\Интерфейс с кнопками\Buttons and RadioButton 2.ui',
# licensing of 'E:\Программы\Программирование\Python\С телефона\Копии для редактирования на компе\Кубик\Интерфейс с кнопками\Buttons and RadioButton 2.ui' applies.
#
# Created: Fri Sep 13 02:32:11 2019
...
"}")
        ...
        self.horizontalLayoutWidget_2.setGeometry(QtCore.QRect(40, 200, 179, 41))
...
"}")
        ...
        self.Rotate_immediately = QtWidgets.QRadioButton(Window)
        self.Rotate_immediately.setGeometry(QtCore.QRect(50, 240, 161, 17))
