...
# Form implementation generated from reading ui file 'E:\Программы\Программирование\Python\С телефона\Копии для редактирования на компе\Кубик\Интерфейс с кнопками\Buttons and RadioButton 1.ui',
# licensing of 'E:\Программы\Программирование\Python\С телефона\Копии для редактирования на компе\Кубик\Интерфейс с кнопками\Buttons and RadioButton 1.ui' applies.
#
# Created: Fri Sep 13 01:37:51 2019
...
"}")
        ...
        self.radioButton.setGeometry(QtCore.QRect(50, 240, 161, 17))
...
"}")
    ...
    def retranslateUi(self, Window):
        ...
        self.radioButton.setText(QtWidgets.QApplication.translate("Window", "Rotate immediately", None, -1))
